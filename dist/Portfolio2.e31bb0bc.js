...
function mailText() {
  ...
  setTimeout(function mailDisplayOut() {
    mailText.classList.toggle("displayCopyText");
  }, 1000);
}
...
function phoneText() {
  var numberText = document.querySelector("#phoneText");
  numberText.classList.toggle("displayCopyText");
  setTimeout(function changingText() {
    numberText.innerText = "06 89 99 46 15";
  }, 1000);
  setTimeout(function mailDisplayOut() {
    numberText.classList.toggle("displayCopyText");
  }, 3000);
  setTimeout(function changingText() {
    numberText.innerText = "Copié !";
  }, 4000);
} //Contact Listenner
...
*/
},{"parallax-js":"node_modules/parallax-js/dist/parallax.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
